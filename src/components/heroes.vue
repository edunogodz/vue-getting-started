        ...
        <div class="card">
          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                <label class="label" for="originDate">description</label>
                <input
                  type="date"
                  class="input"
                  id="originDate"
...
const ourHeroes = [
  {
    ...
    lastName: 'Papa',
    capeCounter: 1,
    originDate: format(new Date(1996, 0, 1), inputDateFormat),
  ...
  },
  {
    ...
    lastName: 'Papa',
    capeCounter: 2,
    originDate: format(new Date(1991, 8, 1), inputDateFormat),
